 ...
 */
router.post("/", participateController.create);
 ...
 */
router.get("/:id", participateController.findOne);
 ...
 *         description: Unauthorized
 */
router.get("/post/:id", participateController.findAllByPostGamesId);
 ...
 *         description: Unauthorized
 */
router.get("/user/:userId", participateController.findAllByUserId);
 ...
 *         description: Participate not found
 */
router.put("/:id", participateController.update);
 ...
 *         description: Participate not found
 */
router.delete("/:id", participateController.delete);
 ...
 *         description: Unauthorized
 */
router.delete("/", participateController.deleteAll);
