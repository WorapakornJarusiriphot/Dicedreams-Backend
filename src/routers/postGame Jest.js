 ...
 */
router.post("/", postGameController.create);
 ...
 *         description: Unauthorized
 */
router.get("/user/:userId", postGameController.findAllUserPosts);
 ...
 */
router.get("/:id", postGameController.findOne);
 ...
 *         description: Game not found
 */
router.put("/:id", postGameController.update);
 ...
 *         description: Game not found
 */
router.delete("/:id", postGameController.delete);
 ...
 *         description: Unauthorized
 */
router.delete("/", postGameController.deleteAll);
