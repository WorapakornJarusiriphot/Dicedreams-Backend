 ...
 */
router.post("/", postActivityController.create);
 ...
 */
router.get("/:id", postActivityController.findOne);
 ...
 *         description: Activity post not found
 */
router.put("/:id", postActivityController.update);
 ...
 *         description: Activity post not found
 */
router.delete("/:id", postActivityController.delete);
 ...
 *         description: Unauthorized
 */
router.delete("/", postActivityController.deleteAll);
 ...
 *         description: Unauthorized
 */
router.get("/store/:storeId", postActivityController.findAllStorePosts);
